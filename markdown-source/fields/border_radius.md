...
**Field type:** `border_radius`  
**Renderer class:** `BorderRadius`  
...
KAVRO::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'type' => 'border_radius',
            'title' => 'Border Radius',
            'subtitle' => 'Border Radius field example.',
            'desc' => 'This is a documented border_radius field example.',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Border Radius Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_border_radius',
            'type'     => 'border_radius',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Border Radius User Field',
    'fields' => array(
        array(
            'id'       => 'demo_border_radius',
            'type'     => 'border_radius',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Border Radius Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_border_radius',
            'type'     => 'border_radius',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Border Radius Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_border_radius',
            'type'     => 'border_radius',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Border Radius Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_border_radius',
            'type'     => 'border_radius',
...
```php
$value = kavro_get_option( $prefix, 'demo_border_radius', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_border_radius', null );
```
...
```php
$value = get_theme_mod( 'demo_border_radius', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_border_radius', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_border_radius', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_border_radius', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_border_radius', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_border_radius', null );
```
...
```php
$value = isset( $atts['demo_border_radius'] ) ? $atts['demo_border_radius'] : null;
```
