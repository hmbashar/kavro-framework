...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Google Fonts Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_google_fonts',
            'type'     => 'google_fonts',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Google Fonts Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_google_fonts',
            'type'     => 'google_fonts',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Google Fonts Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_google_fonts',
            'type'     => 'google_fonts',
...
```php
$value = get_theme_mod( 'demo_google_fonts', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_google_fonts', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_google_fonts', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_google_fonts', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_google_fonts', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_google_fonts', null );
```
...
```php
$value = isset( $atts['demo_google_fonts'] ) ? $atts['demo_google_fonts'] : null;
```
