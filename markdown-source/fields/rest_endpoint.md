...
**Field type:** `rest_endpoint`  
**Renderer class:** `RestEndpoint`  
...
KAVRO::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'type' => 'rest_endpoint',
            'title' => 'Rest Endpoint',
            'subtitle' => 'Rest Endpoint field example.',
            'desc' => 'This is a documented rest_endpoint field example.',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Rest Endpoint Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_rest_endpoint',
            'type'     => 'rest_endpoint',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Rest Endpoint Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_rest_endpoint',
            'type'     => 'rest_endpoint',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Rest Endpoint User Field',
    'fields' => array(
        array(
            'id'       => 'demo_rest_endpoint',
            'type'     => 'rest_endpoint',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Rest Endpoint Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_rest_endpoint',
            'type'     => 'rest_endpoint',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Rest Endpoint Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_rest_endpoint',
            'type'     => 'rest_endpoint',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Rest Endpoint Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_rest_endpoint',
            'type'     => 'rest_endpoint',
...
```php
$value = kavro_get_option( $prefix, 'demo_rest_endpoint', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_rest_endpoint', null );
```
...
```php
$value = get_theme_mod( 'demo_rest_endpoint', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_rest_endpoint', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_rest_endpoint', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_rest_endpoint', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_rest_endpoint', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_rest_endpoint', null );
```
...
```php
$value = isset( $atts['demo_rest_endpoint'] ) ? $atts['demo_rest_endpoint'] : null;
```
