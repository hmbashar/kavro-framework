...
**Field type:** `license_key`  
**Renderer class:** `LicenseKey`  
...
KAVRO::createSection( $prefix, array(
    'title'  => 'License Key Example',
    'fields' => array(
        array(
            'id' => 'demo_license_key',
            'type' => 'license_key',
            'title' => 'License Key',
            'subtitle' => 'License Key field example.',
            'desc' => 'This is a documented license_key field example.',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'License Key Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_license_key',
            'type'     => 'license_key',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'License Key Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_license_key',
            'type'     => 'license_key',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'License Key Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_license_key',
            'type'     => 'license_key',
...
```php
$value = kavro_get_option( $prefix, 'demo_license_key', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_license_key', null );
```
...
```php
$value = get_theme_mod( 'demo_license_key', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_license_key', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_license_key', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_license_key', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_license_key', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_license_key', null );
```
...
```php
$value = isset( $atts['demo_license_key'] ) ? $atts['demo_license_key'] : null;
```
