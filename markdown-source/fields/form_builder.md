...
**Field type:** `form_builder`  
**Renderer class:** `FormBuilder`  
...
KAVRO::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'type' => 'form_builder',
            'title' => 'Form Builder',
            'subtitle' => 'Form Builder field example.',
            'desc' => 'This is a documented form_builder field example.',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Form Builder Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_form_builder',
            'type'     => 'form_builder',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Form Builder Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_form_builder',
            'type'     => 'form_builder',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Form Builder Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_form_builder',
            'type'     => 'form_builder',
...
```php
$value = kavro_get_option( $prefix, 'demo_form_builder', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_form_builder', null );
```
...
```php
$value = get_theme_mod( 'demo_form_builder', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_form_builder', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_form_builder', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_form_builder', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_form_builder', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_form_builder', null );
```
...
```php
$value = isset( $atts['demo_form_builder'] ) ? $atts['demo_form_builder'] : null;
```
