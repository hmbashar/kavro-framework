...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Post Checkbox Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_post_checkbox',
            'type'     => 'post_checkbox',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Post Checkbox Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_checkbox',
            'type'     => 'post_checkbox',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Post Checkbox User Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_checkbox',
            'type'     => 'post_checkbox',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Post Checkbox Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_checkbox',
            'type'     => 'post_checkbox',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Post Checkbox Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_checkbox',
            'type'     => 'post_checkbox',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Post Checkbox Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_checkbox',
            'type'     => 'post_checkbox',
...
```php
$value = get_theme_mod( 'demo_post_checkbox', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_post_checkbox', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_post_checkbox', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_post_checkbox', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_post_checkbox', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_post_checkbox', null );
```
...
```php
$value = isset( $atts['demo_post_checkbox'] ) ? $atts['demo_post_checkbox'] : null;
```
