...
**Field type:** `post_autocomplete`  
**Renderer class:** `WPContent`  
**Aliases using the same renderer:** `cpt_select`, `page_select`, `post_checkbox`, `post_radio`, `post_relation`, `post_select`

## Purpose

AJAX/autocomplete post selector.
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Post Autocomplete Example',
    'fields' => array(
        array(
            'id' => 'demo_post_autocomplete',
            'type' => 'post_autocomplete',
            'title' => 'Post Autocomplete',
            'subtitle' => 'Post Autocomplete field example.',
            'desc' => 'This is a documented post_autocomplete field example.',
            'post_type' => 'post',
            'post_status' => 'publish',
            'limit' => 20,
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Post Autocomplete Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_post_autocomplete',
            'type'     => 'post_autocomplete',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Post Autocomplete Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_autocomplete',
            'type'     => 'post_autocomplete',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Post Autocomplete User Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_autocomplete',
            'type'     => 'post_autocomplete',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Post Autocomplete Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_autocomplete',
            'type'     => 'post_autocomplete',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Post Autocomplete Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_autocomplete',
            'type'     => 'post_autocomplete',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Post Autocomplete Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_post_autocomplete',
            'type'     => 'post_autocomplete',
...
```php
$value = kavro_get_option( $prefix, 'demo_post_autocomplete', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_post_autocomplete', null );
```
...
```php
$value = get_theme_mod( 'demo_post_autocomplete', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_post_autocomplete', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_post_autocomplete', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_post_autocomplete', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_post_autocomplete', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_post_autocomplete', null );
```
...
```php
$value = isset( $atts['demo_post_autocomplete'] ) ? $atts['demo_post_autocomplete'] : null;
```
