...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Permission Matrix Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_permission_matrix',
            'type'     => 'permission_matrix',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Permission Matrix Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_permission_matrix',
            'type'     => 'permission_matrix',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Permission Matrix User Field',
    'fields' => array(
        array(
            'id'       => 'demo_permission_matrix',
            'type'     => 'permission_matrix',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Permission Matrix Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_permission_matrix',
            'type'     => 'permission_matrix',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Permission Matrix Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_permission_matrix',
            'type'     => 'permission_matrix',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Permission Matrix Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_permission_matrix',
            'type'     => 'permission_matrix',
...
```php
$value = get_theme_mod( 'demo_permission_matrix', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_permission_matrix', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_permission_matrix', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_permission_matrix', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_permission_matrix', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_permission_matrix', null );
```
...
```php
$value = isset( $atts['demo_permission_matrix'] ) ? $atts['demo_permission_matrix'] : null;
```
