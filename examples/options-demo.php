<?php
/**
 * Kavro Framework file: examples/options-demo.php.
 *
...
// Options framework demo. Paste this file into a theme functions.php or custom plugin after Kavro Framework is active.
