...
**Field type:** `typography_advanced`  
**Renderer class:** `TypographyAdvanced`  
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Typography Advanced Example',
    'fields' => array(
        array(
            'id' => 'demo_typography_advanced',
            'type' => 'typography_advanced',
            'title' => 'Typography Advanced',
            'subtitle' => 'Typography Advanced field example.',
            'desc' => 'This is a documented typography_advanced field example.',
            'families' => array(
                'Inter' => 'Inter',
                'Roboto' => 'Roboto',
                'Open Sans' => 'Open Sans',
...
KAVRO::createSection( $metabox_prefix, array(
    'title'  => 'Typography Advanced Meta',
    'fields' => array(
        array(
            'id' => 'demo_typography_advanced',
            'type' => 'typography_advanced',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Typography Advanced Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_typography_advanced',
            'type'     => 'typography_advanced',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Typography Advanced Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_typography_advanced',
            'type'     => 'typography_advanced',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Typography Advanced User Field',
    'fields' => array(
        array(
            'id'       => 'demo_typography_advanced',
            'type'     => 'typography_advanced',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Typography Advanced Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_typography_advanced',
            'type'     => 'typography_advanced',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Typography Advanced Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_typography_advanced',
            'type'     => 'typography_advanced',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Typography Advanced Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_typography_advanced',
            'type'     => 'typography_advanced',
...
```php
$value = kavro_get_option( $prefix, 'demo_typography_advanced', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_typography_advanced', null );
```
...
```php
$value = get_theme_mod( 'demo_typography_advanced', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_typography_advanced', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_typography_advanced', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_typography_advanced', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_typography_advanced', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_typography_advanced', null );
```
...
```php
$value = isset( $atts['demo_typography_advanced'] ) ? $atts['demo_typography_advanced'] : null;
```
