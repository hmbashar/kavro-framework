...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Business Hours Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_business_hours',
            'type'     => 'business_hours',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Business Hours Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_business_hours',
            'type'     => 'business_hours',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Business Hours User Field',
    'fields' => array(
        array(
            'id'       => 'demo_business_hours',
            'type'     => 'business_hours',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Business Hours Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_business_hours',
            'type'     => 'business_hours',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Business Hours Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_business_hours',
            'type'     => 'business_hours',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Business Hours Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_business_hours',
            'type'     => 'business_hours',
...
```php
$value = get_theme_mod( 'demo_business_hours', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_business_hours', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_business_hours', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_business_hours', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_business_hours', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_business_hours', null );
```
...
```php
$value = isset( $atts['demo_business_hours'] ) ? $atts['demo_business_hours'] : null;
```
