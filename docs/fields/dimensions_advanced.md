...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Dimensions Advanced Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_dimensions_advanced',
            'type'     => 'dimensions_advanced',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Dimensions Advanced Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_dimensions_advanced',
            'type'     => 'dimensions_advanced',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Dimensions Advanced User Field',
    'fields' => array(
        array(
            'id'       => 'demo_dimensions_advanced',
            'type'     => 'dimensions_advanced',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Dimensions Advanced Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_dimensions_advanced',
            'type'     => 'dimensions_advanced',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Dimensions Advanced Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_dimensions_advanced',
            'type'     => 'dimensions_advanced',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Dimensions Advanced Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_dimensions_advanced',
            'type'     => 'dimensions_advanced',
...
```php
$value = get_theme_mod( 'demo_dimensions_advanced', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_dimensions_advanced', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_dimensions_advanced', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_dimensions_advanced', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_dimensions_advanced', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_dimensions_advanced', null );
```
...
```php
$value = isset( $atts['demo_dimensions_advanced'] ) ? $atts['demo_dimensions_advanced'] : null;
```
