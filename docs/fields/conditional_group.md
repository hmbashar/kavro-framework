...
**Field type:** `conditional_group`  
**Renderer class:** `ConditionalGroup`  
**Aliases using the same renderer:** None

## Purpose

Group with conditional logic patterns.
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Conditional Group Example',
    'fields' => array(
        array(
            'id' => 'demo_conditional_group',
            'type' => 'conditional_group',
            'title' => 'Conditional Group',
            'subtitle' => 'Conditional Group field example.',
            'desc' => 'This is a documented conditional_group field example.',
            'fields' => array(
                array(
                    'id' => 'item_title',
                    'type' => 'text',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Conditional Group Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_conditional_group',
            'type'     => 'conditional_group',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Conditional Group Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_conditional_group',
            'type'     => 'conditional_group',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Conditional Group User Field',
    'fields' => array(
        array(
            'id'       => 'demo_conditional_group',
            'type'     => 'conditional_group',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Conditional Group Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_conditional_group',
            'type'     => 'conditional_group',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Conditional Group Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_conditional_group',
            'type'     => 'conditional_group',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Conditional Group Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_conditional_group',
            'type'     => 'conditional_group',
...
```php
$value = kavro_get_option( $prefix, 'demo_conditional_group', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_conditional_group', null );
```
...
```php
$value = get_theme_mod( 'demo_conditional_group', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_conditional_group', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_conditional_group', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_conditional_group', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_conditional_group', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_conditional_group', null );
```
...
```php
$value = isset( $atts['demo_conditional_group'] ) ? $atts['demo_conditional_group'] : null;
```
