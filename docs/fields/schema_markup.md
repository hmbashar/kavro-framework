...
**Field type:** `schema_markup`  
**Renderer class:** `SchemaMarkup`  
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Schema Markup Example',
    'fields' => array(
        array(
            'id' => 'demo_schema_markup',
            'type' => 'schema_markup',
            'title' => 'Schema Markup',
            'subtitle' => 'Schema Markup field example.',
            'desc' => 'This is a documented schema_markup field example.',
            'default' => array(
                '@type' => 'Thing',
                'name' => 'Kavro',
            ),
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Schema Markup Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_schema_markup',
            'type'     => 'schema_markup',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Schema Markup Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_schema_markup',
            'type'     => 'schema_markup',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Schema Markup User Field',
    'fields' => array(
        array(
            'id'       => 'demo_schema_markup',
            'type'     => 'schema_markup',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Schema Markup Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_schema_markup',
            'type'     => 'schema_markup',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Schema Markup Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_schema_markup',
            'type'     => 'schema_markup',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Schema Markup Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_schema_markup',
            'type'     => 'schema_markup',
...
```php
$value = kavro_get_option( $prefix, 'demo_schema_markup', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_schema_markup', null );
```
...
```php
$value = get_theme_mod( 'demo_schema_markup', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_schema_markup', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_schema_markup', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_schema_markup', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_schema_markup', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_schema_markup', null );
```
...
```php
$value = isset( $atts['demo_schema_markup'] ) ? $atts['demo_schema_markup'] : null;
```
