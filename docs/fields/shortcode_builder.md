# Shortcode Builder Field

**Field type:** `shortcode_builder`  
**Renderer class:** `ShortcodeBuilder`  
**Aliases using the same renderer:** None

## Purpose

Shortcode builder configuration field.
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Shortcode Builder Example',
    'fields' => array(
        array(
            'id' => 'demo_shortcode_builder',
            'type' => 'shortcode_builder',
            'title' => 'Shortcode Builder',
            'subtitle' => 'Shortcode Builder field example.',
            'desc' => 'This is a documented shortcode_builder field example.',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Shortcode Builder Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_shortcode_builder',
            'type'     => 'shortcode_builder',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Shortcode Builder Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_shortcode_builder',
            'type'     => 'shortcode_builder',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Shortcode Builder User Field',
    'fields' => array(
        array(
            'id'       => 'demo_shortcode_builder',
            'type'     => 'shortcode_builder',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Shortcode Builder Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_shortcode_builder',
            'type'     => 'shortcode_builder',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Shortcode Builder Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_shortcode_builder',
            'type'     => 'shortcode_builder',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Shortcode Builder Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_shortcode_builder',
            'type'     => 'shortcode_builder',
...
```php
$value = kavro_get_option( $prefix, 'demo_shortcode_builder', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_shortcode_builder', null );
```
...
```php
$value = get_theme_mod( 'demo_shortcode_builder', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_shortcode_builder', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_shortcode_builder', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_shortcode_builder', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_shortcode_builder', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_shortcode_builder', null );
```
...
```php
$value = isset( $atts['demo_shortcode_builder'] ) ? $atts['demo_shortcode_builder'] : null;
```
