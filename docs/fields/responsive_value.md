# Responsive Value Field

**Field type:** `responsive_value`  
**Renderer class:** `Responsive`  
**Aliases using the same renderer:** None

## Purpose

Desktop/tablet/mobile value control.
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Responsive Value Example',
    'fields' => array(
        array(
            'id' => 'demo_responsive_value',
            'type' => 'responsive_value',
            'title' => 'Responsive Value',
            'subtitle' => 'Responsive Value field example.',
            'desc' => 'This is a documented responsive_value field example.',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Responsive Value Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_responsive_value',
            'type'     => 'responsive_value',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Responsive Value Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_responsive_value',
            'type'     => 'responsive_value',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Responsive Value User Field',
    'fields' => array(
        array(
            'id'       => 'demo_responsive_value',
            'type'     => 'responsive_value',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Responsive Value Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_responsive_value',
            'type'     => 'responsive_value',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Responsive Value Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_responsive_value',
            'type'     => 'responsive_value',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Responsive Value Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_responsive_value',
            'type'     => 'responsive_value',
...
```php
$value = kavro_get_option( $prefix, 'demo_responsive_value', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_responsive_value', null );
```
...
```php
$value = get_theme_mod( 'demo_responsive_value', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_responsive_value', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_responsive_value', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_responsive_value', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_responsive_value', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_responsive_value', null );
```
...
```php
$value = isset( $atts['demo_responsive_value'] ) ? $atts['demo_responsive_value'] : null;
```
