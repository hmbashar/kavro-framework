...
**Field type:** `api_credentials`  
**Renderer class:** `ApiCredentials`  
**Aliases using the same renderer:** None

## Purpose

API key/secret credentials group.
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Api Credentials Example',
    'fields' => array(
        array(
            'id' => 'demo_api_credentials',
            'type' => 'api_credentials',
            'title' => 'Api Credentials',
            'subtitle' => 'Api Credentials field example.',
            'desc' => 'This is a documented api_credentials field example.',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Api Credentials Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_api_credentials',
            'type'     => 'api_credentials',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Api Credentials Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_api_credentials',
            'type'     => 'api_credentials',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Api Credentials User Field',
    'fields' => array(
        array(
            'id'       => 'demo_api_credentials',
            'type'     => 'api_credentials',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Api Credentials Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_api_credentials',
            'type'     => 'api_credentials',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Api Credentials Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_api_credentials',
            'type'     => 'api_credentials',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Api Credentials Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_api_credentials',
            'type'     => 'api_credentials',
...
```php
$value = kavro_get_option( $prefix, 'demo_api_credentials', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_api_credentials', null );
```
...
```php
$value = get_theme_mod( 'demo_api_credentials', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_api_credentials', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_api_credentials', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_api_credentials', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_api_credentials', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_api_credentials', null );
```
...
```php
$value = isset( $atts['demo_api_credentials'] ) ? $atts['demo_api_credentials'] : null;
```
