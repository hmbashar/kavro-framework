...
KAVRO::createSection( $prefix, array(
    'title'  => 'Menu Builder Example',
    'fields' => array(
        array(
            'id' => 'demo_menu_builder',
            'type' => 'menu_builder',
            'title' => 'Menu Builder',
            'subtitle' => 'Menu Builder field example.',
            'desc' => 'This is a documented menu_builder field example.',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Menu Builder Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_menu_builder',
            'type'     => 'menu_builder',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Menu Builder Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_menu_builder',
            'type'     => 'menu_builder',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Menu Builder Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_menu_builder',
            'type'     => 'menu_builder',
...
```php
$value = kavro_get_option( $prefix, 'demo_menu_builder', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_menu_builder', null );
```
...
```php
$value = get_theme_mod( 'demo_menu_builder', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_menu_builder', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_menu_builder', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_menu_builder', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_menu_builder', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_menu_builder', null );
```
...
```php
$value = isset( $atts['demo_menu_builder'] ) ? $atts['demo_menu_builder'] : null;
```
