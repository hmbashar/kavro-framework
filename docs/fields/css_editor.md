...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Css Editor Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_css_editor',
            'type'     => 'css_editor',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Css Editor Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_css_editor',
            'type'     => 'css_editor',
...
```php
$value = get_theme_mod( 'demo_css_editor', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_css_editor', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_css_editor', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_css_editor', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_css_editor', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_css_editor', null );
```
...
```php
$value = isset( $atts['demo_css_editor'] ) ? $atts['demo_css_editor'] : null;
```
