...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Spacing Advanced Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_spacing_advanced',
            'type'     => 'spacing_advanced',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Spacing Advanced Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_spacing_advanced',
            'type'     => 'spacing_advanced',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Spacing Advanced User Field',
    'fields' => array(
        array(
            'id'       => 'demo_spacing_advanced',
            'type'     => 'spacing_advanced',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Spacing Advanced Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_spacing_advanced',
            'type'     => 'spacing_advanced',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Spacing Advanced Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_spacing_advanced',
            'type'     => 'spacing_advanced',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Spacing Advanced Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_spacing_advanced',
            'type'     => 'spacing_advanced',
...
```php
$value = get_theme_mod( 'demo_spacing_advanced', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_spacing_advanced', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_spacing_advanced', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_spacing_advanced', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_spacing_advanced', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_spacing_advanced', null );
```
...
```php
$value = isset( $atts['demo_spacing_advanced'] ) ? $atts['demo_spacing_advanced'] : null;
```
