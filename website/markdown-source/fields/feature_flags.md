...
**Field type:** `feature_flags`  
**Renderer class:** `FeatureFlags`  
...
| Attribute | Type | Description |
|---|---:|---|
| `flags` | array | Feature flag definitions. |
...
KAVRO::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'type' => 'feature_flags',
            'title' => 'Feature Flags',
            'subtitle' => 'Feature Flags field example.',
            'desc' => 'This is a documented feature_flags field example.',
            'flags' => array(
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Feature Flags Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_feature_flags',
            'type'     => 'feature_flags',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Feature Flags Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_feature_flags',
            'type'     => 'feature_flags',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Feature Flags User Field',
    'fields' => array(
        array(
            'id'       => 'demo_feature_flags',
            'type'     => 'feature_flags',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Feature Flags Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_feature_flags',
            'type'     => 'feature_flags',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Feature Flags Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_feature_flags',
            'type'     => 'feature_flags',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Feature Flags Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_feature_flags',
            'type'     => 'feature_flags',
...
```php
$value = kavro_get_option( $prefix, 'demo_feature_flags', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_feature_flags', null );
```
...
```php
$value = get_theme_mod( 'demo_feature_flags', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_feature_flags', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_feature_flags', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_feature_flags', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_feature_flags', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_feature_flags', null );
```
...
```php
$value = isset( $atts['demo_feature_flags'] ) ? $atts['demo_feature_flags'] : null;
```
