...
KAVRO::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'type' => 'password',
            'title' => 'Password',
            'subtitle' => 'Password field example.',
            'desc' => 'This is a documented password field example.',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Password Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_password',
            'type'     => 'password',
...
```php
$value = kavro_get_option( $prefix, 'demo_password', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_password', null );
```
...
```php
$value = get_theme_mod( 'demo_password', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_password', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_password', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_password', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_password', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_password', null );
```
...
```php
$value = isset( $atts['demo_password'] ) ? $atts['demo_password'] : null;
```
