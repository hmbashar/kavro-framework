...
**Field type:** `cache_control`  
**Renderer class:** `CacheControl`  
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Cache Control Example',
    'fields' => array(
        array(
            'id' => 'demo_cache_control',
            'type' => 'cache_control',
            'title' => 'Cache Control',
            'subtitle' => 'Cache Control field example.',
            'desc' => 'This is a documented cache_control field example.',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Cache Control Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_cache_control',
            'type'     => 'cache_control',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Cache Control Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_cache_control',
            'type'     => 'cache_control',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Cache Control User Field',
    'fields' => array(
        array(
            'id'       => 'demo_cache_control',
            'type'     => 'cache_control',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Cache Control Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_cache_control',
            'type'     => 'cache_control',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Cache Control Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_cache_control',
            'type'     => 'cache_control',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Cache Control Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_cache_control',
            'type'     => 'cache_control',
...
```php
$value = kavro_get_option( $prefix, 'demo_cache_control', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_cache_control', null );
```
...
```php
$value = get_theme_mod( 'demo_cache_control', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_cache_control', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_cache_control', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_cache_control', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_cache_control', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_cache_control', null );
```
...
```php
$value = isset( $atts['demo_cache_control'] ) ? $atts['demo_cache_control'] : null;
```
