...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Email Template Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_email_template',
            'type'     => 'email_template',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Email Template User Field',
    'fields' => array(
        array(
            'id'       => 'demo_email_template',
            'type'     => 'email_template',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Email Template Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_email_template',
            'type'     => 'email_template',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Email Template Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_email_template',
            'type'     => 'email_template',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Email Template Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_email_template',
            'type'     => 'email_template',
...
```php
$value = get_theme_mod( 'demo_email_template', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_email_template', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_email_template', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_email_template', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_email_template', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_email_template', null );
```
...
```php
$value = isset( $atts['demo_email_template'] ) ? $atts['demo_email_template'] : null;
```
