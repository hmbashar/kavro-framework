# Color Picker Alpha Field

**Field type:** `color_picker_alpha`  
**Renderer class:** `ColorAlpha`  
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Color Picker Alpha Example',
    'fields' => array(
        array(
            'id' => 'demo_color_picker_alpha',
            'type' => 'color_picker_alpha',
            'title' => 'Color Picker Alpha',
            'subtitle' => 'Color Picker Alpha field example.',
            'desc' => 'This is a documented color_picker_alpha field example.',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Color Picker Alpha Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_color_picker_alpha',
            'type'     => 'color_picker_alpha',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Color Picker Alpha Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_color_picker_alpha',
            'type'     => 'color_picker_alpha',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Color Picker Alpha User Field',
    'fields' => array(
        array(
            'id'       => 'demo_color_picker_alpha',
            'type'     => 'color_picker_alpha',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Color Picker Alpha Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_color_picker_alpha',
            'type'     => 'color_picker_alpha',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Color Picker Alpha Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_color_picker_alpha',
            'type'     => 'color_picker_alpha',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Color Picker Alpha Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_color_picker_alpha',
            'type'     => 'color_picker_alpha',
...
```php
$value = kavro_get_option( $prefix, 'demo_color_picker_alpha', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_color_picker_alpha', null );
```
...
```php
$value = get_theme_mod( 'demo_color_picker_alpha', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_color_picker_alpha', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_color_picker_alpha', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_color_picker_alpha', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_color_picker_alpha', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_color_picker_alpha', null );
```
...
```php
$value = isset( $atts['demo_color_picker_alpha'] ) ? $atts['demo_color_picker_alpha'] : null;
```
