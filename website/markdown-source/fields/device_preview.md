# Device Preview Field

**Field type:** `device_preview`  
**Renderer class:** `DevicePreview`  
**Aliases using the same renderer:** None

## Purpose

Device preview helper/control.
...
KAVRO::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'subtitle' => 'Device Preview field example.',
            'desc' => 'This is a documented device_preview field example.',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Device Preview Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_device_preview',
            'type'     => 'device_preview',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Device Preview Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_device_preview',
            'type'     => 'device_preview',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Device Preview User Field',
    'fields' => array(
        array(
            'id'       => 'demo_device_preview',
            'type'     => 'device_preview',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Device Preview Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_device_preview',
            'type'     => 'device_preview',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Device Preview Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_device_preview',
            'type'     => 'device_preview',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Device Preview Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_device_preview',
            'type'     => 'device_preview',
...
```php
$value = kavro_get_option( $prefix, 'demo_device_preview', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_device_preview', null );
```
...
```php
$value = get_theme_mod( 'demo_device_preview', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_device_preview', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_device_preview', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_device_preview', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_device_preview', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_device_preview', null );
```
...
```php
$value = isset( $atts['demo_device_preview'] ) ? $atts['demo_device_preview'] : null;
```
