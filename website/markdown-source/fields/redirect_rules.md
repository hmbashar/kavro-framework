# Redirect Rules Field

**Field type:** `redirect_rules`  
**Renderer class:** `RedirectRules`  
...
KAVRO::createSection( $prefix, array(
    'title'  => 'Redirect Rules Example',
    'fields' => array(
        array(
            'id' => 'demo_redirect_rules',
            'type' => 'redirect_rules',
            'title' => 'Redirect Rules',
            'subtitle' => 'Redirect Rules field example.',
            'desc' => 'This is a documented redirect_rules field example.',
...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Redirect Rules Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_redirect_rules',
            'type'     => 'redirect_rules',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Redirect Rules Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_redirect_rules',
            'type'     => 'redirect_rules',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Redirect Rules User Field',
    'fields' => array(
        array(
            'id'       => 'demo_redirect_rules',
            'type'     => 'redirect_rules',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Redirect Rules Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_redirect_rules',
            'type'     => 'redirect_rules',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Redirect Rules Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_redirect_rules',
            'type'     => 'redirect_rules',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Redirect Rules Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_redirect_rules',
            'type'     => 'redirect_rules',
...
```php
$value = kavro_get_option( $prefix, 'demo_redirect_rules', null );
```

### From Metabox

```php
$value = kavro_get_post_meta( get_the_ID(), $metabox_prefix, 'demo_redirect_rules', null );
```
...
```php
$value = get_theme_mod( 'demo_redirect_rules', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_redirect_rules', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_redirect_rules', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_redirect_rules', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_redirect_rules', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_redirect_rules', null );
```
...
```php
$value = isset( $atts['demo_redirect_rules'] ) ? $atts['demo_redirect_rules'] : null;
```
