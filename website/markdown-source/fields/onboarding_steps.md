...
KAVRO::createSection( $customize_prefix, array(
    'title'  => 'Onboarding Steps Customizer',
    'fields' => array(
        array(
            'id'       => 'demo_onboarding_steps',
            'type'     => 'onboarding_steps',
...
KAVRO::createSection( $taxonomy_prefix, array(
    'title'  => 'Onboarding Steps Term Field',
    'fields' => array(
        array(
            'id'       => 'demo_onboarding_steps',
            'type'     => 'onboarding_steps',
...
KAVRO::createSection( $profile_prefix, array(
    'title'  => 'Onboarding Steps User Field',
    'fields' => array(
        array(
            'id'       => 'demo_onboarding_steps',
            'type'     => 'onboarding_steps',
...
KAVRO::createSection( $nav_menu_prefix, array(
    'title'  => 'Onboarding Steps Menu Item Field',
    'fields' => array(
        array(
            'id'       => 'demo_onboarding_steps',
            'type'     => 'onboarding_steps',
...
KAVRO::createSection( $widget_prefix, array(
    'title'  => 'Onboarding Steps Widget Field',
    'fields' => array(
        array(
            'id'       => 'demo_onboarding_steps',
            'type'     => 'onboarding_steps',
...
KAVRO::createSection( $comment_prefix, array(
    'title'  => 'Onboarding Steps Comment Field',
    'fields' => array(
        array(
            'id'       => 'demo_onboarding_steps',
            'type'     => 'onboarding_steps',
...
```php
$value = get_theme_mod( 'demo_onboarding_steps', null );
```

### From Taxonomy Options

```php
$value = kavro_get_term_meta( $term_id, $taxonomy_prefix, 'demo_onboarding_steps', null );
```

### From Profile/User Options

```php
$value = kavro_get_user_meta( $user_id, $profile_prefix, 'demo_onboarding_steps', null );
```

### From Nav Menu Options

```php
$value = kavro_get_nav_menu_item_meta( $menu_item_id, $nav_menu_prefix, 'demo_onboarding_steps', null );
```

### From Widget Options

```php
$value = kavro_get_widget_option( $widget_id, $widget_prefix, 'demo_onboarding_steps', null );
```

### From Comment Options

```php
$value = kavro_get_comment_meta( $comment_id, $comment_prefix, 'demo_onboarding_steps', null );
```
...
```php
$value = isset( $atts['demo_onboarding_steps'] ) ? $atts['demo_onboarding_steps'] : null;
```
