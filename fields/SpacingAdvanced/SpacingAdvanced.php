...
/**
 * Renders the SpacingAdvanced field.
 */
class SpacingAdvanced extends AbstractField {
    /**
    ...
    public function render() {
        ...
        $parts = (array) $this->attr( 'options', array( 'top' => 'Top', 'right' => 'Right', 'bottom' => 'Bottom', 'left' => 'Left' ) );
